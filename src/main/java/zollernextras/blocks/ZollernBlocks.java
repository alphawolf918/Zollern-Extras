...
public class ZollernBlocks {
	...
	public static final Block upsideDownAmberOre = ((ZollernBlockBase) new ZollernGemOre(
			"ud_amberore", 1.6F, ZollernItems.amber)
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block enderFueltoniumOre = (((ZollernBlockOre) ((ZollernBlockOre) new ZollernGemOre(
			...
			.setBlockVariant(EnumBlockVariant.END)).setBlockHarvestLevel(
			"pickaxe", EnumHarvestLevel.DIAMOND.getHarvestLevel()))
	...
	public static final Block upsideDownTopazOre = ((ZollernBlockBase) new ZollernGemOre(
			"ud_topazore", 1.6F, ZollernItems.topaz)
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block upsideDownRubyOre = ((ZollernBlockBase) new ZollernGemOre(
			"ud_rubyore", 1.6F, ZollernItems.ruby)
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block upsideDownOpalOre = ((ZollernBlockBase) new ZollernGemOre(
			"ud_opalore", 1.6F, ZollernItems.opal)
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block zollerniumOre = new ZollernBlockOre(
			...
			EnumHarvestLevel.AZURITE.getHarvestLevel());
	...
	public static final Block upsideDownDiamondOre = ((ZollernBlockBase) new ZollernGemOre(
			"ud_diamondore", 4.6F, Items.DIAMOND)
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block upsideDownEmeraldOre = ((ZollernBlockBase) new ZollernGemOre(
			"ud_emeraldore", 4.6F, Items.EMERALD)
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block upsideDownRedstoneOre = ((ZollernBlockBase) new ZollernGemOre(
			"ud_redstoneore", 4.2F, Items.REDSTONE)
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block upsideDownTinOre = ((ZollernBlockBase) new ZollernBlockOre(
			"ud_tinore", 4.6F).setBlockVariant(EnumBlockVariant.UPSIDE_DOWN))
			.setBlockHarvestLevel("pickaxe",
					EnumHarvestLevel.AMARANTH.getHarvestLevel());
	...
	public static final Block blackCaveMarble = new ZollernBlockBase(
			"blackmarble", 1.4F).setBlockHarvestLevel("pickaxe", 2)
			.setLightLevel(0.5F);
	
	// Shinestone Stuff
	public static final Block shinestone = new BlockShinestone();
	public static final Block shinestoneCrystal = new ShineBlock(
			"shinestonecrystal");
	public static final Block shinestonePolished = new ShineBlock(
			"polishedshinestone");
	public static final Block shinestoneCrystalBricks = new ShineBlock(
			"crystalbricks").setHardness(1.4F);
	...
	public static final Block shadowBoneBlock = new ZollernBlockBase(
			"shadowboneblock", 2.4F);
	public static final Block seaLamp = ((ZollernBlockBase) new ZollernBlockBase(
			"sealamp", 3.5F).setLightLevel(1.0F)).setSound(SoundType.GLASS);
	...
	public static final Block hellObsidian = new ZollernBlockBase(
			"redobsidian", 5.6F).setShouldAlwaysBurn(true).setLightLevel(1.0F);
	...
	public static final Block upsideDownStoneBricks = new ZollernBlockBase(
			"ud_stonebricks", 1.2F);
	...
	public static final Block creepStone = new ZollernBlockBase("creepstone",
			1.4F);
	public static final Block creepDirt = new ZollernDirt("creepdirt", 1.6F)
			.setBlockHarvestLevel("shovel", 2);
	public static final Block shadowEssenceBlock = new ZollernBlockBase(
			"shadowessenceblock", 1.4F);
	...
	// Blocks
	public static final Block corruptCobble = new CorruptBlock("corruptcobble",
			0.5F);
	public static final Block corruptStone = new CorruptStone();
	public static final Block corruptStoneBricks = new CorruptBlock(
			"corruptstonebricks", 1.2F);
	public static final Block corruptRock = new CorruptBlock("corruptrock",
			1.9F);
	...
	public static final Block corruptEtriumOre = ((ZollernBlockBase) ((ZollernGemOre) new CorruptGemOre(
			...
			.setBlockVariant(EnumBlockVariant.UPSIDE_DOWN)).setMinMaxDropped(2,
			4)).setBlockHarvestLevel("pickaxe",
			EnumHarvestLevel.AMARANTH.getHarvestLevel());
