...
public class CropPeas extends BlockCrops {
	...
	public CropPeas() {
		...
		ZollernHelper.setName(this, "peas");
		ZollernHelper.setTexture(this, "peas");
	...
	public Item func_149866_i() {
		return ZollernItems.pea;
	}
	
	@Override
	public Item func_149865_P() {
		return ZollernItems.peaPod;
	}
}