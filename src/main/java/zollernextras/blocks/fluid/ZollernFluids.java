...
public class ZollernFluids {
	...
	public static void registerFluids() {
		fluidChargium = new Fluid("chargium", new ResourceLocation(ZollernModInfo.modId,
				"blocks/chargiumfluid"), new ResourceLocation(ZollernModInfo.modId,
				"blocks/chargiumfluid"));
		fluidFueltonium = new Fluid("fueltonium", new ResourceLocation(ZollernModInfo.modId,
				"blocks/fuel"), new ResourceLocation(ZollernModInfo.modId, "blocks/fuel"));
		fluidWhiteLava = new Fluid("whitelava", new ResourceLocation(ZollernModInfo.modId,
				"blocks/whitelava"), new ResourceLocation(ZollernModInfo.modId, "blocks/whitelava"));
