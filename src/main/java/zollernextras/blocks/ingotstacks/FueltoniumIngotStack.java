...
public class FueltoniumIngotStack extends BlockContainer {
	
	private float boundingBoxMaxY = 0.6F;
	
	public FueltoniumIngotStack(String strTexture) {
		super(Material.iron);
		ZollernHelper.setTab(this);
		ZollernHelper.setName(this, "ingotBlock_" + strTexture);
		ZollernHelper.setTexture(this, "fueltoniumblock");
	...
	public Item getItemDropped(int meta, Random rand, int p_149650_3_) {
		return ZollernItems.ingotFueltonium;
	}
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TEFueltoniumBlockIngot();
	}
}