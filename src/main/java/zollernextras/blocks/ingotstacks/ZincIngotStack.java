...
public class ZincIngotStack extends BlockContainer {
	
	private float boundingBoxMaxY = 0.6F;
	
	public ZincIngotStack(String strTexture) {
		super(Material.iron);
		ZollernHelper.setTab(this);
		ZollernHelper.setName(this, "ingotBlock_" + strTexture);
		ZollernHelper.setTexture(this, "zincblock");
