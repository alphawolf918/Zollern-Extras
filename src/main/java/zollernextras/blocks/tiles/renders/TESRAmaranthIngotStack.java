...
public class TESRAmaranthIngotStack extends TileEntitySpecialRenderer {
	
	ResourceLocation amaranth = new ResourceLocation(ZollernModInfo.MODID,
			"textures/blocks/amaranthblock.png");
