...
public class TESRFueltoniumIngotStack extends TileEntitySpecialRenderer {
	
	ResourceLocation fueltonium = new ResourceLocation(ZollernModInfo.MODID,
			"textures/blocks/fueltoniumblock.png");
	IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(
			ZollernModInfo.MODID, "obj/ingotstack.obj"));
	float scalex = 0.080F;
	float scaley = 0.20F;
	float scalez = 0.06F;
	float offset = 0.3F;
