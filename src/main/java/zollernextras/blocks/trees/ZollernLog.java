...
public class ZollernLog extends BlockRotatedPillar {
	...
	public ZollernLog(String logTexture) {
		super(Material.wood);
		this.strTexture = logTexture;
		this.setCreativeTab(ModTabs.zTab);
		this.setHardness(2.0F);
		this.setResistance(2.0F);
		this.setBlockName(ZollernModInfo.MODID + "_" + strTexture);
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_.registerIcon("zollernextras:"
				+ strTexture + "_side");
		this.field_150166_b = p_149651_1_.registerIcon("zollernextras:"
				+ strTexture + "_top");
	}
