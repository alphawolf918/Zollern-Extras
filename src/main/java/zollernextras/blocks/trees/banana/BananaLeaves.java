package zollernextras.blocks.trees.banana;
...
public class BananaLeaves extends BlockLeavesBase implements IShearable {
	...
	public BananaLeaves() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_bpalmleaves");
		this.setBlockTextureName(ZollernModInfo.MODID + ":bpalmleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.banana;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.bananaSapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.bananaSapling);
			break;
