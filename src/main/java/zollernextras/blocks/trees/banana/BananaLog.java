...
public class BananaLog extends BlockRotatedPillar {
	...
	public BananaLog() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_bpalmlog");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_
				.registerIcon("zollernextras:bpalmlog_side");
		this.field_150166_b = p_149651_1_
				.registerIcon("zollernextras:bpalmlog_top");
	}
