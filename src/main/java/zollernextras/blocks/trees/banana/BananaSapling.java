...
public class BananaSapling extends BlockBush implements IGrowable {
	public static final String field_149882_a = "";
	private static IIcon field_149881_b;
	
	public BananaSapling() {
		this.setCreativeTab(ModTabs.zTab);
		this.setBlockName(ZollernModInfo.MODID + "_bpalmsapling");
		this.setBlockTextureName(ZollernModInfo.MODID + ":bpalmsapling");
		float f = 0.4F;
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149881_b = p_149651_1_.registerIcon("zollernextras:bpalmsapling");
	}
