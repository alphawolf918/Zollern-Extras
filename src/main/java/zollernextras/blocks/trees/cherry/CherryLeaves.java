...
public class CherryLeaves extends BlockLeavesBase implements IShearable {
	...
	public CherryLeaves() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_cherryleaves");
		this.setBlockTextureName(ZollernModInfo.MODID + ":cherryleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.cherry;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.cherrySapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.cherrySapling);
			break;
