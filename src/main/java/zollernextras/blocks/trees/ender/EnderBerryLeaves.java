...
public class EnderBerryLeaves extends BlockLeavesBase implements IShearable {
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.enderBerry;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.enderBerrySapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.enderBerrySapling);
			break;
