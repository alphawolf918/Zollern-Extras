package zollernextras.blocks.trees.ender;
...
public class EnderBerryLog extends BlockRotatedPillar {
	...
	public EnderBerryLog() {
		super(Material.wood);
		this.setCreativeTab(ModTabs.zTab);
		this.setHardness(2.0F);
		this.setResistance(2.0F);
		this.setBlockName(ZollernModInfo.MODID + "_enderberrylog");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_
				.registerIcon("zollernextras:enderberrylog_side");
		this.field_150166_b = p_149651_1_
				.registerIcon("zollernextras:enderberrylog_top");
	}
