package zollernextras.blocks.trees.grapefruit;
...
public class GrapefruitLeaves extends BlockLeavesBase implements IShearable {
	
	private IIcon texture;
	int[] adjacentTreeBlocks;
	
	public GrapefruitLeaves() {
		super(Material.leaves, false);
		this.setCreativeTab(ModTabs.zTab);
		this.setBlockName(ZollernModInfo.MODID + "_grapefruitleaves");
		this.setBlockTextureName(ZollernModInfo.MODID + ":grapefruitleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.grapefruit;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.grapefruitSapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.grapefruitSapling);
			break;
