...
public class GrapefruitLog extends BlockRotatedPillar {
	...
	public GrapefruitLog() {
		super(Material.wood);
		this.setCreativeTab(ModTabs.zTab);
		this.setHardness(2.0F);
		this.setResistance(2.0F);
		this.setBlockName(ZollernModInfo.MODID + "_grapefruitlog");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_
				.registerIcon("zollernextras:grapefruitlog_side");
		this.field_150166_b = p_149651_1_
				.registerIcon("zollernextras:grapefruitlog_top");
	}
