...
public class GuavaLog extends BlockRotatedPillar {
	...
	public GuavaLog() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_guavalog");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_
				.registerIcon("zollernextras:guavalog_side");
		this.field_150166_b = p_149651_1_
				.registerIcon("zollernextras:guavalog_top");
	}
