package zollernextras.blocks.trees.guava;
...
public class GuavaSapling extends BlockBush implements IGrowable {
	public static final String field_149882_a = "";
	private static IIcon field_149881_b;
	
	public GuavaSapling() {
		this.setCreativeTab(ModTabs.zTab);
		this.setBlockName(ZollernModInfo.MODID + "_guavasapling");
		this.setBlockTextureName(ZollernModInfo.MODID + ":guavasapling");
		float f = 0.4F;
	...
	public void func_149878_d(World world, int x, int y, int z, Random random) {
		...
		if (obj == null) {
			obj = new WorldGenFruitTree(ZollernBlocks.guavaLog,
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149881_b = p_149651_1_.registerIcon("zollernextras:guavasapling");
	}
