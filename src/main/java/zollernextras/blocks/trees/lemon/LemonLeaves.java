...
public class LemonLeaves extends BlockLeavesBase implements IShearable {
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.lemon;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.lemonSapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.lemonSapling);
			break;
