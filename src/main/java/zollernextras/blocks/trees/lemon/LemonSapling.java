package zollernextras.blocks.trees.lemon;
...
public class LemonSapling extends BlockBush implements IGrowable {
	public static final String field_149882_a = "";
	private static IIcon field_149881_b;
	
	public LemonSapling() {
		this.setCreativeTab(ModTabs.zTab);
		this.setBlockName(ZollernModInfo.MODID + "_lemonsapling");
		this.setBlockTextureName(ZollernModInfo.MODID + ":lemonsapling");
		float f = 0.4F;
	...
	public void func_149878_d(World world, int x, int y, int z, Random random) {
		...
		if (obj == null) {
			obj = new WorldGenFruitTree(ZollernBlocks.lemonLog,
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149881_b = p_149651_1_.registerIcon("zollernextras:lemonsapling");
	}
