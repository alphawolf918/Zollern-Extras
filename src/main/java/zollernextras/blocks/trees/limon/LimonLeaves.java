...
public class LimonLeaves extends BlockLeavesBase implements IShearable {
	...
	public LimonLeaves() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_limonleaves");
		this.setBlockTextureName(ZollernModInfo.MODID + ":limonleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.limon;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.limonSapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.limonSapling);
			break;
