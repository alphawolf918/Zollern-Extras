package zollernextras.blocks.trees.orange;
...
public class OrangeLeaves extends BlockLeavesBase implements IShearable {
	...
	public OrangeLeaves() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_orangeleaves");
		this.setBlockTextureName(ZollernModInfo.MODID + ":orangeleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.orange;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.orangeSapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.orangeSapling);
			break;
