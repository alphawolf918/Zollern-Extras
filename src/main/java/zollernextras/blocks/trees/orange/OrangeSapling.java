...
public class OrangeSapling extends BlockBush implements IGrowable {
	...
	public OrangeSapling() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_orangesapling");
		this.setBlockTextureName(ZollernModInfo.MODID + ":orangesapling");
		float f = 0.4F;
	...
	public void func_149878_d(World world, int x, int y, int z, Random random) {
		...
		if (obj == null) {
			obj = new WorldGenFruitTree(ZollernBlocks.orangeLog,
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149881_b = p_149651_1_
				.registerIcon("zollernextras:orangesapling");
	}
