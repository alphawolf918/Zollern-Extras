...
public class PeachLeaves extends BlockLeavesBase implements IShearable {
	...
	public PeachLeaves() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_peachleaves");
		this.setBlockTextureName(ZollernModInfo.MODID + ":peachleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		...
		switch (dropCheck) {
		case 0:
			droppedItem = ZollernItems.peach;
			break;
		case 1:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.peachSapling);
			break;
		default:
			droppedItem = Item.getItemFromBlock(ZollernBlocks.peachSapling);
			break;
