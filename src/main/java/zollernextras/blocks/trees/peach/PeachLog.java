...
public class PeachLog extends BlockRotatedPillar {
	...
	public PeachLog() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_peachlog");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_
				.registerIcon("zollernextras:peachlog_side");
		this.field_150166_b = p_149651_1_
				.registerIcon("zollernextras:peachlog_top");
	}
