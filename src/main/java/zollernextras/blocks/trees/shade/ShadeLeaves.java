...
public class ShadeLeaves extends BlockLeavesBase implements IShearable {
	...
	public ShadeLeaves() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_shadeleaves");
		this.setBlockTextureName(ZollernModInfo.MODID + ":shadeleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		Item droppedItem = Item.getItemFromBlock(ZollernBlocks.shadeSapling);
		return droppedItem;
	}
