...
public class ShadeLog extends BlockRotatedPillar {
	...
	public ShadeLog() {
		...
		this.setBlockName(ZollernModInfo.MODID + "_shadelog");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.field_150167_a = p_149651_1_
				.registerIcon("zollernextras:shadelog_side");
		this.field_150166_b = p_149651_1_
				.registerIcon("zollernextras:shadelog_top");
	}
