package zollernextras.blocks.trees.shade;
...
public class ShadeSapling extends BlockBush implements IGrowable {
	public static final String field_149882_a = "";
	private static IIcon field_149881_b;
	
	public ShadeSapling() {
		this.setCreativeTab(ModTabs.zTab);
		this.setBlockName(ZollernModInfo.MODID + "_shadesapling");
		this.setBlockTextureName(ZollernModInfo.MODID + ":shadesapling");
		float f = 0.4F;
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149881_b = p_149651_1_.registerIcon("zollernextras:shadesapling");
	}
	...
	protected boolean canPlaceBlockOn(Block block) {
		return block == ZollernBlocks.upsideDownDirt;
	}
}