...
public class MapGenCavesUpsideDown extends MapGenBase {
	...
	protected void func_151542_a(long p_151542_1_, int p_151542_3_,
		...
		this.func_151541_a(p_151542_1_, p_151542_3_, p_151542_4_, p_151542_5_,
	...
	protected void func_151541_a(long p_151541_1_, int p_151541_3_,
		...
		for (boolean flag = random.nextInt(6) == 0; p_151541_15_ < p_151541_16_; ++p_151541_15_) {
			...
			if (!flag2 && p_151541_15_ == k1 && p_151541_12_ > 1.0F
					&& p_151541_16_ > 0) {
			...
			if (flag2 || random.nextInt(4) != 0) {
				...
				if (p_151541_6_ >= d4 - 16.0D - d6 * 2.0D
						&& p_151541_10_ >= d5 - 16.0D - d6 * 2.0D
						&& p_151541_6_ <= d4 + 16.0D + d6 * 2.0D
						&& p_151541_10_ <= d5 + 16.0D + d6 * 2.0D) {
					int i4 = MathHelper.floor_double(p_151541_6_ - d6)
							- p_151541_3_ * 16 - 1;
					int l1 = MathHelper.floor_double(p_151541_6_ + d6)
							- p_151541_3_ * 16 + 1;
					int j4 = MathHelper.floor_double(p_151541_8_ - d7) - 1;
					int i2 = MathHelper.floor_double(p_151541_8_ + d7) + 1;
					int k4 = MathHelper.floor_double(p_151541_10_ - d6)
							- p_151541_4_ * 16 - 1;
					int j2 = MathHelper.floor_double(p_151541_10_ + d6)
							- p_151541_4_ * 16 + 1;
						...
						for (int l2 = k4; !flag3 && l2 < j2; ++l2) {
							for (int i3 = i2 + 1; !flag3 && i3 >= j4 - 1; --i3) {
								...
								if (i3 >= 0 && i3 < 256) {
									...
									if (isOceanBlock(p_151541_5_, j3, k2, i3,
											l2, p_151541_3_, p_151541_4_)) {
										flag3 = true;
									}
					...
					if (!flag3) {
						for (k2 = i4; k2 < l1; ++k2) {
							double d13 = (k2 + p_151541_3_ * 16 + 0.5D - p_151541_6_)
									/ d6;
							
							for (j3 = k4; j3 < j2; ++j3) {
								double d14 = (j3 + p_151541_4_ * 16 + 0.5D - p_151541_10_)
										/ d6;
								...
								if (d13 * d13 + d14 * d14 < 1.0D) {
									for (int l3 = i2 - 1; l3 >= j4; --l3) {
										double d12 = (l3 + 0.5D - p_151541_8_)
												/ d7;
	...
	protected void func_151538_a(World p_151538_1_, int p_151538_2_,
		...
		for (int j1 = 0; j1 < i1; ++j1) {
			...
			if (this.rand.nextInt(4) == 0) {
				this.func_151542_a(this.rand.nextLong(), p_151538_4_,
						p_151538_5_, p_151538_6_, d0, d1, d2);
			...
			for (int l1 = 0; l1 < k1; ++l1) {
				...
				this.func_151541_a(this.rand.nextLong(), p_151538_4_,
	...
	protected boolean isOceanBlock(Block[] data, int index, int x, int y,
		...
		return data[index] == Blocks.flowing_water
	...
	protected void digBlock(Block[] data, int index, int x, int y, int z,
		...
		BiomeGenBase biome = worldObj.getBiomeGenForCoords(x + chunkX * 16, z
				+ chunkZ * 16);
		Block top = isExceptionBiome(biome) ? ZollernBlocks.upsideDownSurfaceRock
				: biome.topBlock;
		Block filler = isExceptionBiome(biome) ? ZollernBlocks.upsideDownRock
				: biome.fillerBlock;
