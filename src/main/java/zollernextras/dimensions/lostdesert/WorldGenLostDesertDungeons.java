...
public class WorldGenLostDesertDungeons extends WorldGenerator {
	public static final WeightedRandomChestContent[] field_111189_a = new WeightedRandomChestContent[] {
		...
		new WeightedRandomChestContent(ItemList.amaranthIngot, 0, 1, 4, 10),
						...
						if (k1 != p_76484_3_ - l - 1 && l1 != p_76484_4_ - 1
							...
							if (l1 == p_76484_4_ - 1
								...
								p_76484_1_.setBlock(k1, l1, i2,
										BlockList.creepDirt, 0, 2);
							} else {
								p_76484_1_.setBlock(k1, l1, i2,
										BlockList.creepStone, 0, 2);
							}
						}
					}
				}
