...
public class ZollernBucket extends ZollernContainer {
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		if (movingobjectposition == null) {
			...
			FillBucketEvent event = new FillBucketEvent(p_77659_3_, p_77659_1_,
					p_77659_2_, movingobjectposition);
			...
			if (event.getResult() == Event.Result.ALLOW) {
				...
				if (!p_77659_3_.inventory.addItemStackToInventory(event.result)) {
					p_77659_3_.dropPlayerItemWithRandomChoice(event.result,
							false);
				}
			...
			if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
				...
				if (flag) {
					if (!p_77659_3_.canPlayerEdit(i, j, k,
							movingobjectposition.sideHit, p_77659_1_)) {
						return p_77659_1_;
					}
					
					Material material = p_77659_2_.getBlock(i, j, k)
							.getMaterial();
					int l = p_77659_2_.getBlockMetadata(i, j, k);
					
					if (material == Material.water && l == 0) {
						p_77659_2_.setBlockToAir(i, j, k);
						return this.func_150910_a(p_77659_1_, p_77659_3_,
								Items.water_bucket);
					}
	...
	public boolean tryPlaceContainedLiquid(World p_77875_1_, int p_77875_2_,
		...
		if (this.isFull == Blocks.air) {
			...
			Material material = p_77875_1_.getBlock(p_77875_2_, p_77875_3_,
