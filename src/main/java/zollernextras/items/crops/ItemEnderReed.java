...
public class ItemEnderReed extends ModItem {
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (!p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_,
			...
			if (p_77648_3_.canPlaceEntityOnSide(this.field_150935_a,
					p_77648_4_, p_77648_5_, p_77648_6_, false, p_77648_7_,
					(Entity) null, p_77648_1_)) {
				int i1 = this.field_150935_a.onBlockPlaced(p_77648_3_,
				...
				if (p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_,
						this.field_150935_a, i1, 3)) {
					if (p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_) == this.field_150935_a) {
						this.field_150935_a.onBlockPlacedBy(p_77648_3_,
								p_77648_4_, p_77648_5_, p_77648_6_, p_77648_2_,
								p_77648_1_);
						this.field_150935_a.onPostBlockPlaced(p_77648_3_,
								p_77648_4_, p_77648_5_, p_77648_6_, i1);
					}
