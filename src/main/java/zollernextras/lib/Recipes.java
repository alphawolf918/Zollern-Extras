...
public class Recipes {
	...
	static class Crafting {
		static void init() {
			...
			// <azurite>
			// Pickaxe
			GameRegistry.addRecipe(new ItemStack(ItemList.azuritePickaxe, 1),
					new Object[] { "RRR", " S ", " S ", 'R', ItemList.azurite,
				'S', Items.stick });
			// Shovel
			GameRegistry.addRecipe(new ItemStack(ItemList.azuriteShovel, 1),
					new Object[] { " R ", " S ", " S ", 'R', ItemList.azurite,
				'S', Items.stick });
			// Axe
			GameRegistry.addRecipe(new ItemStack(ItemList.azuriteAxe, 1),
					new Object[] { " RR", " SR", " S ", 'R', ItemList.azurite,
				'S', Items.stick });
			GameRegistry.addRecipe(new ItemStack(ItemList.azuriteAxe, 1),
					new Object[] { "RR ", "RS ", " S ", 'R', ItemList.azurite,
				'S', Items.stick });
			// Hoe
			GameRegistry.addRecipe(new ItemStack(ItemList.azuriteHoe, 1),
					new Object[] { "RR ", " S ", " S ", 'R', ItemList.azurite,
				'S', Items.stick });
			GameRegistry.addRecipe(new ItemStack(ItemList.azuriteHoe, 1),
					new Object[] { " RR", " S ", " S ", 'R', ItemList.azurite,
				'S', Items.stick });
			// Sword
			GameRegistry.addRecipe(new ItemStack(ItemList.azuriteSword, 1),
					new Object[] { " R ", " R ", " S ", 'R', ItemList.azurite,
				'S', Items.stick });
			
			// Helmet
			GameRegistry
			.addRecipe(new ItemStack(ItemList.azuriteHelmet),
					new Object[] { "ZZZ", "Z Z", "   ", 'Z',
				ItemList.azurite });
			
			// Chestplate
			GameRegistry
			.addRecipe(new ItemStack(ItemList.azuriteChestPlate),
					new Object[] { "Z Z", "ZZZ", "ZZZ", 'Z',
				ItemList.azurite });
			
			// Leggings
			GameRegistry
			.addRecipe(new ItemStack(ItemList.azuriteLeggings),
					new Object[] { "ZZZ", "Z Z", "Z Z", 'Z',
				ItemList.azurite });
			
			// Boots
			GameRegistry
			.addRecipe(new ItemStack(ItemList.azuriteBoots),
					new Object[] { "   ", "Z Z", "Z Z", 'Z',
				ItemList.azurite });
			GameRegistry
			.addRecipe(new ItemStack(ItemList.azuriteBoots),
