...
public class ToolRecipes {
	...
	public static void init() {
		...
		addToolSet(new ItemStack(ZollernItems.zollerniumPickaxe, 1), ZollernItems.zollerniumIngot,
				"pickaxe");
		...
		RecipeHelper.addToolSet(azuritePickaxe, ZollernItems.azurite, "pickaxe");
		addToolSet(new ItemStack(ZollernItems.rubyPickaxe, 1), ZollernItems.ruby, "pickaxe");
		addToolSet(new ItemStack(ZollernItems.sapphirePickaxe, 1), ZollernItems.sapphire, "pickaxe");
		...
		addToolSet(new ItemStack(ZollernItems.zollerniumShovel, 1), ZollernItems.zollerniumIngot,
				"shovel");
		...
		addToolSet(new ItemStack(ZollernItems.rubyShovel, 1), ZollernItems.ruby, "shovel");
		addToolSet(new ItemStack(ZollernItems.sapphireShovel, 1), ZollernItems.sapphire, "shovel");
		...
		addToolSet(new ItemStack(ZollernItems.zollerniumAxe, 1), ZollernItems.zollerniumIngot,
				"axe");
		...
		addToolSet(new ItemStack(ZollernItems.sapphireAxe, 1), ZollernItems.sapphire, "axe");
		...
		addToolSet(new ItemStack(ZollernItems.zollerniumHoe, 1), ZollernItems.zollerniumIngot,
				"hoe");
		addToolSet(new ItemStack(ZollernItems.rubyHoe, 1), ZollernItems.ruby, "hoe");
		addToolSet(new ItemStack(ZollernItems.sapphireHoe, 1), ZollernItems.sapphire, "hoe");
		...
		addToolSet(new ItemStack(ZollernItems.zollerniumSword, 1), ZollernItems.zollerniumIngot,
				"sword");
		...
		addToolSet(new ItemStack(ZollernItems.rubySword, 1), ZollernItems.ruby, "sword");
		addToolSet(new ItemStack(ZollernItems.sapphireSword, 1), ZollernItems.sapphire, "sword");
	}
