...
public class EntityHelleton extends EntityMob implements IRangedAttackMob {
	...
	public EntityHelleton(World p_i1741_1_) {
		super(p_i1741_1_);
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, new EntityAIRestrictSun(this));
		this.tasks.addTask(3, new EntityAIWander(this, 1.4D));
		...
		this.addPotionEffect(new PotionEffect(Potion.resistance.id, 3, 2));
	}
	...
	protected void dropRareDrop(int p_70600_1_) {
		this.entityDropItem(new ItemStack(Items.bow), 0.0F);
	}
