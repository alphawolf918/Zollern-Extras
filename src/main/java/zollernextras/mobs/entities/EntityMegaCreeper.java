...
public class EntityMegaCreeper extends EntityCreeper {
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityPlayer.class,
				true));
	...
	private void explode() {
		if (!this.world.isRemote) {
			...
			float f = 2.5F;
			this.dead = true;
			this.world.createExplosion(this, this.posX, this.posY, this.posZ, this.explosionRadius
					* f, flag);
			this.setDead();
