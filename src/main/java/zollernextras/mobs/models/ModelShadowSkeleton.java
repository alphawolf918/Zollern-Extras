...
public class ModelShadowSkeleton extends ModelZombie {
	/**
	...
	public ModelShadowSkeleton() {
		this(0.0F);
	}
	
	public ModelShadowSkeleton(float par1) {
	...
	public void setLivingAnimations(EntityLivingBase par1EntityLivingBase,
		...
		this.aimedBow = ((EntityShadowSkeleton) par1EntityLivingBase)
				.getSkeletonType() == 1;
