...
public class RenderEnderSkeleton extends RenderLiving {
	
	public ModelEnderSkeleton model;
	...
	float f6 = 1.4F;
	public Item bowItem = ItemList.enderBow;
	
	public RenderEnderSkeleton(ModelEnderSkeleton par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		model = (ModelEnderSkeleton) mainModel;
	...
	protected void renderEquippedItems(EntityLiving par1EntityLiving, float par2) {
		...
		if (itemstack != null) {
			...
			if (itemstack.getItem() instanceof ItemBlock
				...
				GL11.glScalef(-f2, -f2, f2);
			} else if (itemstack.getItem() == bowItem) {
				f2 = 0.625F;
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"zollernextras:textures/entity/enderskeleton.png");
	}
	
	public void renderTutorial(EntityEnderSkeleton entity, double par2,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntityEnderSkeleton) par1EntityLiving, par2, par4,
				par6, par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntityEnderSkeleton) par1Entity, par2, par4, par6,
				par8, par9);
	}
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleEnderSkeleton((EntityEnderSkeleton) par1EntityLivingBase,
				par2);
	}
}