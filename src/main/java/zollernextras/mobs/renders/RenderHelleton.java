...
public class RenderHelleton extends RenderLiving {
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"zollernextras:textures/entity/helleton.png");
	}
	
	public void renderTutorial(EntityHelleton entity, double par2, double par4,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
		...
		renderTutorial((EntityHelleton) par1EntityLiving, par2, par4, par6,
				par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderTutorial((EntityHelleton) par1Entity, par2, par4, par6, par8,
				par9);
	}
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleHelleton((EntityHelleton) par1EntityLivingBase, par2);
	}
}