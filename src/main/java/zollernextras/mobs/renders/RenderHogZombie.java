...
public class RenderHogZombie extends RenderLiving {
	...
	protected void scaleHogZombie(EntityHogZombie par1EntityCaveSpider,
			float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleHogZombie((EntityHogZombie) par1EntityLivingBase, par2);
	}
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"zollernextras:textures/entity/zombie_hogman.png");
	}
