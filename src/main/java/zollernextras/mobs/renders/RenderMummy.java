...
public class RenderMummy extends RenderLiving {
	...
	public RenderMummy(ModelMummy par1ModelBase, float par2) {
		super(par1ModelBase, par2);
		model = (ModelMummy) mainModel;
		...
		if (itemstack1 != null) {
			...
			if (itemstack1.getItem() instanceof ItemBlock) {
				...
				if (itemstack1.hasTagCompound()
						&& itemstack1.getTagCompound().hasKey("SkullOwner")) {
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation("zollernextras:textures/entity/mummy.png");
	}
	
	public void renderTutorial(EntityMummy entity, double par2, double par4,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
		...
		renderTutorial((EntityMummy) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderTutorial((EntityMummy) par1Entity, par2, par4, par6, par8, par9);
	}
	
	protected void scaleMummy(EntityMummy par1EntityMummy, float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleMummy((EntityMummy) par1EntityLivingBase, par2);
	}
}