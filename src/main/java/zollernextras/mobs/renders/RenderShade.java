...
public class RenderShade extends RenderLiving {
	...
	public RenderShade(ModelShade par1ModelBase, float par2) {
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation("zollernextras:textures/entity/shade.png");
	}
	
	public void renderTutorial(EntityShade entity, double par2, double par4,
	...
	public void doRender(EntityLiving par1EntityLiving, double par2,
		...
		renderTutorial((EntityShade) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderTutorial((EntityShade) par1Entity, par2, par4, par6, par8, par9);
	}
	
	protected void scaleShade(EntityShade par1EntityShade, float par2) {
	...
	protected void preRenderCallback(EntityLivingBase par1EntityLivingBase,
			float par2) {
		this.scaleShade((EntityShade) par1EntityLivingBase, par2);
	}
}