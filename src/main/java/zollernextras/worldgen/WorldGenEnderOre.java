...
public class WorldGenEnderOre extends WorldGenerator {
	
	private Block _minableBlockId;
	private int _numberOfBlocks;
	
	public WorldGenEnderOre(Block blockId, int numBlocks) {
				...
				for (int blockY = yStart; blockY <= yStop; blockY++) {
					...
					for (int blockZ = zStart; blockZ <= zStop; blockZ++) {
						...
						if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D
								&& world.getBlock(blockX, blockY, blockZ) == Blocks.end_stone) {
