...
public class WorldGenSeaLamp extends WorldGenerator {
	...
	public WorldGenSeaLamp(Block par1, int par2) {
		this(par1, par2, Block.getBlockById(9));
	}
	
	public WorldGenSeaLamp(Block par1, int par2, Block par3) {
		this.minableBlockId = par1;
		this.numberOfBlocks = par2;
		this.blockToReplace = par3;
	}
	
	public WorldGenSeaLamp(Block id, int meta, int number, Block target) {
