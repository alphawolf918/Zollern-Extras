...
public class WorldGenShadowLakes extends WorldGenerator {
	
	private Block field_150556_a;
	
	public WorldGenShadowLakes(Block p_i45455_1_) {
			...
			for (i1 = 0; i1 < 16; ++i1) {
				for (j2 = 0; j2 < 16; ++j2) {
					for (j1 = 4; j1 < 8; ++j1) {
						if (aboolean[(i1 * 16 + j2) * 8 + j1]
								&& p_76484_1_.getBlock(p_76484_3_ + i1,
										p_76484_4_ + j1 - 1, p_76484_5_ + j2) == ZollernBlocks.upsideDownDirt
					...
					for (j2 = 0; j2 < 16; ++j2) {
						for (j1 = 0; j1 < 8; ++j1) {
							...
							if (flag
								...
								p_76484_1_.setBlock(p_76484_3_ + i1, p_76484_4_
										+ j1, p_76484_5_ + j2,
										ZollernBlocks.upsideDownStone, 0, 2);
							}
						}
					}
				}
				...
				for (i1 = 0; i1 < 16; ++i1) {
					for (j2 = 0; j2 < 16; ++j2) {
						...
						if (p_76484_1_.isBlockFreezable(p_76484_3_ + i1,
							...
							p_76484_1_.setBlock(p_76484_3_ + i1, p_76484_4_
									+ b0, p_76484_5_ + j2, Blocks.packed_ice,
									0, 2);
						}
					}
				}
